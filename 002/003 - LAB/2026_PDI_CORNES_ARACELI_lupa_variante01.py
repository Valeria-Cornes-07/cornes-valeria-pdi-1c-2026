...
def draw():
    ...
    # en lugar de mostrar el color original del píxel,
    # se muestra su color negativo o complementario
    # cada canal se invierte restándolo a 255
    py5.fill(255 - r, 255 - g, 255 - b)

    py5.stroke(0)
    py5.rect(450, 50, 300, 300)

    # Mostrar los valores numéricos del píxel original
    py5.fill(0)
    py5.text_size(18)
